...
function renderLanding() {
  ...
  if (!sessionStorage.getItem('landingViewed')) {
    sendAnalyticsEvent('5912_page_view_kk_var3', '5912_page_view_kk_var3');
  ...
  app.innerHTML = `
    <div class="landing">
      ...
      <div class="landing__content">
        ...
        <button class="landing__button" id="sendBtn">Подключить за 490 ₽</button>
      </div>
    </div>
  `;
  document.getElementById('sendBtn').onclick = () => {
    // Отправляем событие клика по кнопке
    sendAnalyticsEvent('5912_click_order_var3', '5912_click_order_var3');
    // Переход по URL вместо показа заглушки
    window.location.href = 'alfabank://sdui_screen?screenName=InvestmentLongread&fromCurrent=true&endpoint=v1/invest-main-screen-view/investment-longread/66431%3flocation=AM%26campaignCode=GH';
  };
}
